...
import ouvriros.app.Profile;
import ouvriros.app.ProfileGroup;
import ouvriros.app.ProfileManager;
import ouvriros.app.IProfileManager;
...
/** @hide */
public class ProfileManagerService extends OuvrirSystemService {

    private static final String TAG = "OuvrirProfileService";
    ...
    private class ProfilesObserver extends ContentObserver {
        ...
        public void onChange(boolean selfChange, Uri uri) {
            int state = OuvrirSettings.System.getInt(mContext.getContentResolver(),
    ...
    public String getFeatureDeclaration() {
        return OuvrirContextConstants.Features.PROFILES;
    }
    ...
    public void onStart() {
        ...
        mWildcardGroup = new NotificationGroup(
                mContext.getString(org.ouvriros.platform.internal.R.string.wildcardProfile),
                org.ouvriros.platform.internal.R.string.wildcardProfile,
                mWildcardUUID);
        ...
        if (mContext.getPackageManager().hasSystemFeature(
                OuvrirContextConstants.Features.PROFILES)) {
            publishBinderService(OuvrirContextConstants.OUVRIR_PROFILE_SERVICE, mService);
        } else {
            Log.wtf(TAG, "Ouvrir profile service started by system server but feature xml not" +
    ...
    public void onBootPhase(int phase) {
        if (phase == PHASE_ACTIVITY_MANAGER_READY) {
            ...
            mContext.getContentResolver().registerContentObserver(
                    OuvrirSettings.System.getUriFor(OuvrirSettings.System.SYSTEM_PROFILES_ENABLED),
    ...
    private void enforceChangePermissions() {
        mContext.enforceCallingOrSelfPermission(
                ouvriros.platform.Manifest.permission.MODIFY_PROFILES,
    ...
    private void initialiseStructure() throws XmlPullParserException, IOException {
        XmlResourceParser xml = mContext.getResources().getXml(
                org.ouvriros.platform.internal.R.xml.profile_default);
        try {
