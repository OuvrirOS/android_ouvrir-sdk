...
import static ouvriros.hardware.LiveDisplayManager.MODE_AUTO;
import static ouvriros.hardware.LiveDisplayManager.MODE_DAY;
import static ouvriros.hardware.LiveDisplayManager.MODE_NIGHT;
...
public class ColorTemperatureController extends LiveDisplayFeature {
    ...
    private static final Uri DISPLAY_TEMPERATURE_DAY =
            OuvrirSettings.System.getUriFor(OuvrirSettings.System.DISPLAY_TEMPERATURE_DAY);
    private static final Uri DISPLAY_TEMPERATURE_NIGHT =
            OuvrirSettings.System.getUriFor(OuvrirSettings.System.DISPLAY_TEMPERATURE_NIGHT);
    ...
    public ColorTemperatureController(Context context,
        ...
        mUseColorBalance = mHardware
                .isSupported(OuvrirHardwareManager.FEATURE_COLOR_BALANCE);
        ...
        mDefaultDayTemperature = mContext.getResources().getInteger(
                org.ouvriros.platform.internal.R.integer.config_dayColorTemperature);
        mDefaultNightTemperature = mContext.getResources().getInteger(
                org.ouvriros.platform.internal.R.integer.config_nightColorTemperature);

        mColorTemperatureRange = Range.create(
                mContext.getResources().getInteger(
                        org.ouvriros.platform.internal.R.integer.config_minColorTemperature),
                mContext.getResources().getInteger(
                        org.ouvriros.platform.internal.R.integer.config_maxColorTemperature));

        mColorBalanceCurve = org.ouvriros.internal.util.MathUtils.powerCurve(
    ...
    private int mapColorTemperatureToBalance(int temperature) {
        double z = org.ouvriros.internal.util.MathUtils.powerCurveToLinear(mColorBalanceCurve, temperature);
    ...
    int getDayColorTemperature() {
        return getInt(OuvrirSettings.System.DISPLAY_TEMPERATURE_DAY,
                mDefaultDayTemperature);
    }

    void setDayColorTemperature(int temperature) {
        putInt(OuvrirSettings.System.DISPLAY_TEMPERATURE_DAY, temperature);
    }

    int getNightColorTemperature() {
        return getInt(OuvrirSettings.System.DISPLAY_TEMPERATURE_NIGHT,
                mDefaultNightTemperature);
    }

    void setNightColorTemperature(int temperature) {
        putInt(OuvrirSettings.System.DISPLAY_TEMPERATURE_NIGHT, temperature);
    }
