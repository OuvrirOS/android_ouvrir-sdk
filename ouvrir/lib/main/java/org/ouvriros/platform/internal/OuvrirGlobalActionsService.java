...
import static ouvriros.providers.OuvrirSettings.Secure.POWER_MENU_ACTIONS;
import static ouvriros.providers.OuvrirSettings.Secure.getStringForUser;
import static ouvriros.providers.OuvrirSettings.Secure.putStringForUser;

import static org.ouvriros.internal.util.PowerMenuConstants.GLOBAL_ACTION_KEY_BUGREPORT;
import static org.ouvriros.internal.util.PowerMenuConstants.GLOBAL_ACTION_KEY_LOCKDOWN;
...
import ouvriros.app.IOuvrirGlobalActions;

import org.ouvriros.internal.util.PowerMenuConstants;
 ...
 * @hide
 */
public class OuvrirGlobalActionsService extends OuvrirSystemService {

    private static final String TAG = "OuvrirGlobalActions";
    ...
    public OuvrirGlobalActionsService(Context context) {
        super(context);
    ...
    public String getFeatureDeclaration() {
        return OuvrirContextConstants.Features.GLOBAL_ACTIONS;
    }

    @Override
    public void onStart() {
        publishBinderService(OuvrirContextConstants.OUVRIR_GLOBAL_ACTIONS_SERVICE, mBinder);
    }
    ...
    private final IBinder mBinder = new IOuvrirGlobalActions.Stub() {
