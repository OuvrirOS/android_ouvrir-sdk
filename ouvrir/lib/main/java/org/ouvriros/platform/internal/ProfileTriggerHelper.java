...
import ouvriros.app.Profile.ProfileTrigger;
    ...
    public ProfileTriggerHelper(Context context, Handler handler,
       ...
       // mIntentFilter.addAction(AudioManager.A2DP_ROUTE_CHANGED_ACTION);
        ...
        mContext.getContentResolver().registerContentObserver(
                OuvrirSettings.System.getUriFor(OuvrirSettings.System.SYSTEM_PROFILES_ENABLED), false,
                mSettingsObserver);
    }

    public void updateEnabled() {
        boolean enabled = OuvrirSettings.System.getInt(mContext.getContentResolver(),
                OuvrirSettings.System.SYSTEM_PROFILES_ENABLED, 1) == 1;
