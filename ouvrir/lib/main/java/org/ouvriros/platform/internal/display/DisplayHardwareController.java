 ...
 */
package org.ouvriros.platform.internal.display;
...
public class DisplayHardwareController extends LiveDisplayFeature {
    ...
    private final OuvrirHardwareManager mHardware;
    ...
    private static final Uri DISPLAY_AUTO_CONTRAST =
            OuvrirSettings.System.getUriFor(OuvrirSettings.System.DISPLAY_AUTO_CONTRAST);
    private static final Uri DISPLAY_COLOR_ADJUSTMENT =
            OuvrirSettings.System.getUriFor(OuvrirSettings.System.DISPLAY_COLOR_ADJUSTMENT);
    private static final Uri DISPLAY_COLOR_ENHANCE =
            OuvrirSettings.System.getUriFor(OuvrirSettings.System.DISPLAY_COLOR_ENHANCE);
    private static final Uri DISPLAY_CABC =
            OuvrirSettings.System.getUriFor(OuvrirSettings.System.DISPLAY_CABC);
    private static final Uri DISPLAY_READING_MODE =
            OuvrirSettings.System.getUriFor(OuvrirSettings.System.DISPLAY_READING_MODE);
    private static final Uri DISPLAY_ANTI_FLICKER =
            OuvrirSettings.System.getUriFor(OuvrirSettings.System.DISPLAY_ANTI_FLICKER);
    ...
    public DisplayHardwareController(Context context, Handler handler) {
        ...
        mUseCABC = mHardware
                .isSupported(OuvrirHardwareManager.FEATURE_ADAPTIVE_BACKLIGHT);
        mDefaultCABC = mContext.getResources().getBoolean(
                org.ouvriros.platform.internal.R.bool.config_defaultCABC);

        mUseColorEnhancement = mHardware
                .isSupported(OuvrirHardwareManager.FEATURE_COLOR_ENHANCEMENT);
        mDefaultColorEnhancement = mContext.getResources().getBoolean(
                org.ouvriros.platform.internal.R.bool.config_defaultColorEnhancement);

        mUseAutoContrast = mHardware
                .isSupported(OuvrirHardwareManager.FEATURE_AUTO_CONTRAST);
        mDefaultAutoContrast = mContext.getResources().getBoolean(
                org.ouvriros.platform.internal.R.bool.config_defaultAutoContrast);

        mUseColorAdjustment = mHardware
                .isSupported(OuvrirHardwareManager.FEATURE_DISPLAY_COLOR_CALIBRATION);

        mUseDisplayModes = mHardware
                .isSupported(OuvrirHardwareManager.FEATURE_DISPLAY_MODES);

        mUseReaderMode = mHardware
                .isSupported(OuvrirHardwareManager.FEATURE_READING_ENHANCEMENT);

        mUseAntiFlicker = mHardware
                .isSupported(OuvrirHardwareManager.FEATURE_ANTI_FLICKER);
        mDefaultAntiFlicker = mContext.getResources().getBoolean(
                org.ouvriros.platform.internal.R.bool.config_defaultAntiFlicker);
    ...
    private void updateAutoContrast() {
        ...
        mHardware.set(OuvrirHardwareManager.FEATURE_AUTO_CONTRAST, isAutoContrastEnabled());
    }
    ...
    private void updateColorEnhancement() {
        ...
        mHardware.set(OuvrirHardwareManager.FEATURE_COLOR_ENHANCEMENT,
    ...
    private void updateCABCMode() {
        ...
        mHardware.set(OuvrirHardwareManager.FEATURE_ADAPTIVE_BACKLIGHT, isCABCEnabled());
    }
    ...
    private void updateAntiFlicker() {
        ...
        mHardware.set(OuvrirHardwareManager.FEATURE_ANTI_FLICKER, isAntiFlickerEnabled());
    }
    ...
    boolean isAutoContrastEnabled() {
        return mUseAutoContrast &&
                getBoolean(OuvrirSettings.System.DISPLAY_AUTO_CONTRAST, mDefaultAutoContrast);
    }
    ...
    boolean setAutoContrastEnabled(boolean enabled) {
        ...
        putBoolean(OuvrirSettings.System.DISPLAY_AUTO_CONTRAST, enabled);
        return true;
    }

    boolean isCABCEnabled() {
        return mUseCABC &&
                getBoolean(OuvrirSettings.System.DISPLAY_CABC, mDefaultCABC);
    }
    ...
    boolean setCABCEnabled(boolean enabled) {
        ...
        putBoolean(OuvrirSettings.System.DISPLAY_CABC, enabled);
        return true;
    }

    boolean isColorEnhancementEnabled() {
        return mUseColorEnhancement &&
                getBoolean(OuvrirSettings.System.DISPLAY_COLOR_ENHANCE,
    ...
    boolean setColorEnhancementEnabled(boolean enabled) {
        ...
        putBoolean(OuvrirSettings.System.DISPLAY_COLOR_ENHANCE, enabled);
        return true;
    }
    ...
    float[] getColorAdjustment() {
        ...
        if (!parseColorAdjustment(getString(OuvrirSettings.System.DISPLAY_COLOR_ADJUSTMENT), cur)) {
    ...
    private void saveColorAdjustmentString(final float[] adj) {
        ...
        putString(OuvrirSettings.System.DISPLAY_COLOR_ADJUSTMENT, sb.toString());
    }
    ...
    boolean isAntiFlickerEnabled() {
        return mUseAntiFlicker &&
                getBoolean(OuvrirSettings.System.DISPLAY_ANTI_FLICKER, mDefaultAntiFlicker);
    }
    ...
    boolean setAntiFlickerEnabled(boolean enabled) {
        ...
        putBoolean(OuvrirSettings.System.DISPLAY_ANTI_FLICKER, enabled);
        return true;
    }
}
