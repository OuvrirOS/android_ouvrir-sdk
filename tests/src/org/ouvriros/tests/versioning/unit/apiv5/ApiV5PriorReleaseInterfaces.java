...
package org.ouvriros.tests.versioning.unit.apiv5;
...
public class ApiV5PriorReleaseInterfaces {
    ...
    //OuvrirAudioManager Aidl (IOuvrirAudioService)
    static {
        Map<String, Integer> ouvrirAudioService =
                getInternalInterfaceMap("IOuvrirAudioService");
        //ELDERBERRY BEGIN
        ouvrirAudioService.put("listAudioSessions", 1);
    }
