...
package org.ouvriros.tests.versioning.unit.apiv2;
...
public class ApiV2PriorReleaseInterfaces {
    ...
    //OuvrirHardwareManager Aidl (IOuvrirHardwareService)
    static {
        Map<String, Integer> hardwareMap = getInternalInterfaceMap("IOuvrirHardwareService");
        // APRICOT + BOYSENBERRY + CANTALOUPE
    ...
    //OuvrirStatusBarManager Aidl (IOuvrirStatusBarManager)
    static {
        Map<String, Integer> statusBarMap = getInternalInterfaceMap("IOuvrirStatusBarManager");
        // APRICOT + BOYSENBERRY + CANTALOUPE
    ...
    //OuvrirTelephonyManager Aidl (IOuvrirTelephonyManager)
    static {
        Map<String, Integer> telephonyMap = getInternalInterfaceMap("IOuvrirTelephonyManager");
        // APRICOT + BOYSENBERRY + CANTALOUPE
