...
package org.ouvriros.tests.profiles.unit;
...
public class ProfileManagerTest extends AndroidTestCase {
    ...
    public void testManagerProfileIsEnabled() {
        ...
        assertTrue(OuvrirSettings.System.putString(getContext().getContentResolver(),
                OuvrirSettings.System.SYSTEM_PROFILES_ENABLED, enabledValue));

        // check that we successfully enabled them via system setting
        assertEquals(enabledValue, OuvrirSettings.System.getString(getContext().getContentResolver(),
        ...
        assertTrue(OuvrirSettings.System.putString(getContext().getContentResolver(),
                OuvrirSettings.System.SYSTEM_PROFILES_ENABLED, disabledValue));

        // check that we successfully disable them via system setting
        assertEquals(disabledValue, OuvrirSettings.System.getString(getContext().getContentResolver(),
                OuvrirSettings.System.SYSTEM_PROFILES_ENABLED));
    ...
    public void testGetProfileNames() {
        ...
        // These defaults are pulled from the default xml in the ouvrir platform resource package
