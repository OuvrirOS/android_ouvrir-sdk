...
package org.ouvriros.tests.hardware;
...
import ouvriros.hardware.DisplayMode;

import org.ouvriros.tests.TestActivity;

/**
 * Created by adnan on 8/31/15.
 */
public class OuvrirHardwareTest extends TestActivity {
    private OuvrirHardwareManager mHardwareManager;

    private static final List<Integer> FEATURES = Arrays.asList(
            OuvrirHardwareManager.FEATURE_ADAPTIVE_BACKLIGHT,
            OuvrirHardwareManager.FEATURE_COLOR_ENHANCEMENT,
            OuvrirHardwareManager.FEATURE_DISPLAY_COLOR_CALIBRATION,
            OuvrirHardwareManager.FEATURE_HIGH_TOUCH_SENSITIVITY,
            OuvrirHardwareManager.FEATURE_KEY_DISABLE,
            OuvrirHardwareManager.FEATURE_SUNLIGHT_ENHANCEMENT,
            OuvrirHardwareManager.FEATURE_TOUCH_HOVERING,
            OuvrirHardwareManager.FEATURE_AUTO_CONTRAST,
            OuvrirHardwareManager.FEATURE_DISPLAY_MODES
    );
    ...
    public void onCreate(Bundle icicle) {
        ...
        mHardwareManager = OuvrirHardwareManager.getInstance(this);
    }
    ...
    private boolean vibratorSupported() {
        if (mHardwareManager.isSupported(OuvrirHardwareManager.FEATURE_VIBRATOR)) {
            return true;
        } else {
            Toast.makeText(OuvrirHardwareTest.this, "Vibrator not supported",
    ...
    private boolean displayColorCalibrationSupported() {
        if (mHardwareManager.isSupported(OuvrirHardwareManager.FEATURE_DISPLAY_COLOR_CALIBRATION)) {
            return true;
        } else {
            Toast.makeText(OuvrirHardwareTest.this, "Display Color Calibration not supported",
                    Toast.LENGTH_SHORT).show();
            return false;
        }
    }
    ...
    private boolean displayModesSupported() {
        if (mHardwareManager.isSupported(OuvrirHardwareManager.FEATURE_DISPLAY_MODES)) {
            return true;
        } else {
            Toast.makeText(OuvrirHardwareTest.this, "Display modes not supported",
                    Toast.LENGTH_SHORT).show();
            return false;
        }
    }
    ...
    private Test[] mTests = new Test[] {
            new Test("Test get supported features") {
                public void run() {
                    Toast.makeText(OuvrirHardwareTest.this, "Supported features " +
            ...
            new Test("Test boolean features enabled") {
                ...
                protected void run() {
                    ...
                    Toast.makeText(OuvrirHardwareTest.this, "Features " +
                                    builder.toString(),
                            Toast.LENGTH_SHORT).show();
                }
            },
            new Test("Test get vibrator intensity") {
                ...
                protected void run() {
                    if (vibratorSupported()) {
                        Toast.makeText(OuvrirHardwareTest.this, "Vibrator intensity " +
            ...
            new Test("Test get vibrator default intensity") {
                ...
                protected void run() {
                    if (vibratorSupported()) {
                        Toast.makeText(OuvrirHardwareTest.this, "Vibrator default intensity " +
            ...
            new Test("Test get vibrator max intensity") {
                ...
                protected void run() {
                    if (vibratorSupported()) {
                        Toast.makeText(OuvrirHardwareTest.this, "Vibrator max intensity " +
            ...
            new Test("Test get vibrator min intensity") {
                ...
                protected void run() {
                    if (vibratorSupported()) {
                        Toast.makeText(OuvrirHardwareTest.this, "Vibrator min intensity " +
            ...
            new Test("Test Display Color Calibration") {
                ...
                protected void run() {
                    if (displayColorCalibrationSupported()) {
                        Toast.makeText(OuvrirHardwareTest.this, "Display Color Calibration " +
            ...
            new Test("Test Default Display Color Calibration") {
                ...
                protected void run() {
                    if (displayColorCalibrationSupported()) {
                        Toast.makeText(OuvrirHardwareTest.this, "Default Display Color Calibration " +
            ...
            new Test("Test Display Color Calibration Max") {
                ...
                protected void run() {
                    if (displayColorCalibrationSupported()) {
                        Toast.makeText(OuvrirHardwareTest.this, "Display Color Calibration Max " +
            ...
            new Test("Test Display Color Calibration Min") {
                ...
                protected void run() {
                    if (displayColorCalibrationSupported()) {
                        Toast.makeText(OuvrirHardwareTest.this, "Display Color Calibration Min " +
            ...
            new Test("Test Get Display Modes") {
                ...
                protected void run() {
                    if (displayModesSupported()) {
                        ...
                        Toast.makeText(OuvrirHardwareTest.this, "Display modes: \n"
            ...
            new Test("Test Get Current Display Mode") {
                ...
                protected void run() {
                    if (displayModesSupported()) {
                        Toast.makeText(OuvrirHardwareTest.this, "Default Display Mode " +
