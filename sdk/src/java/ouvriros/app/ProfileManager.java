...
public class ProfileManager {
    ...
    public static final String INTENT_ACTION_PROFILE_SELECTED =
            "ouvriros.platform.intent.action.PROFILE_SELECTED";
    ...
    public static final String INTENT_ACTION_PROFILE_UPDATED =
            "ouvriros.platform.intent.action.PROFILE_UPDATED";
    ...
    public static final String INTENT_ACTION_PROFILE_TRIGGER_STATE_CHANGED =
            "ouvriros.platform.intent.action.INTENT_ACTION_PROFILE_TRIGGER_STATE_CHANGED";
    ...
    public static final String ACTION_PROFILE_PICKER =
            "ouvriros.platform.intent.action.PROFILE_PICKER";
    ...
    public static final String EXTRA_PROFILE_SHOW_NONE =
            "ouvriros.platform.intent.extra.profile.SHOW_NONE";
    ...
    public static final String EXTRA_PROFILE_EXISTING_UUID =
            "ouvriros.platform.extra.profile.EXISTING_UUID";
    ...
    public static final String EXTRA_PROFILE_TITLE =
            "ouvriros.platform.intent.extra.profile.TITLE";
    ...
    public static final String EXTRA_PROFILE_PICKED_UUID =
            "ouvriros.platform.intent.extra.profile.PICKED_UUID";
    ...
    public static final String PROFILES_STATE_CHANGED_ACTION =
        "ouvriros.platform.app.profiles.PROFILES_STATE_CHANGED";
    ...
    public static final String EXTRA_PROFILE_DIALOG_THEME =
            "ouvriros.platform.intent.extra.profile.DIALOG_THEME";
    ...
    private ProfileManager(Context context) {
        ...
        if (context.getPackageManager().hasSystemFeature(
                ouvriros.app.OuvrirContextConstants.Features.PROFILES) && sService == null) {
    ...
    /**
     * Get or create an instance of the {@link ouvriros.app.ProfileManager}
     * @param context
    ...
    static public IProfileManager getService() throws RemoteException {
        ...
        IBinder b = ServiceManager.getService(OuvrirContextConstants.OUVRIR_PROFILE_SERVICE);
        sService = IProfileManager.Stub.asInterface(b);

        if (sService == null) {
            throw new RemoteException("Couldn't get " +
                                      OuvrirContextConstants.OUVRIR_PROFILE_SERVICE +
                                      " on binder");
        }
        return sService;
    }
