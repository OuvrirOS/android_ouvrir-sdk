...
public class TrustInterface {
     ...
     */
    public static final String TRUST_INTERFACE_PERMISSION = "ouvriros.permission.TRUST_INTERFACE";
    ...
    private TrustInterface(Context context) {
        ...
        if (context.getPackageManager().hasSystemFeature(
                OuvrirContextConstants.Features.TRUST) && sService == null) {
    ...
    /**
     * Get or create an instance of the {@link ouvriros.trust.TrustInterface}
     *
    ...
    public static ITrustInterface getService() {
        ...
        IBinder b = ServiceManager.getService(OuvrirContextConstants.OUVRIR_TRUST_INTERFACE);
