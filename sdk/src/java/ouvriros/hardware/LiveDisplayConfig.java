...
import static ouvriros.hardware.LiveDisplayManager.FEATURE_COLOR_BALANCE;
import static ouvriros.hardware.LiveDisplayManager.FEATURE_PICTURE_ADJUSTMENT;
import static ouvriros.hardware.LiveDisplayManager.FEATURE_FIRST;
import static ouvriros.hardware.LiveDisplayManager.FEATURE_LAST;
...
import ouvriros.os.Build;
import ouvriros.os.Concierge;
import ouvriros.os.Concierge.ParcelInfo;
...
public class LiveDisplayConfig implements Parcelable {
    ...
    private LiveDisplayConfig(Parcel parcel) {
        ...
        if (parcelableVersion >= Build.OUVRIR_VERSION_CODES.FIG) {
