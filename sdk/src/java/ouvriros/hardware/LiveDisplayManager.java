...
public class LiveDisplayManager {
    ...
    private LiveDisplayManager(Context context) {
        ...
        if (!context.getPackageManager().hasSystemFeature(
                OuvrirContextConstants.Features.LIVEDISPLAY) || !checkService()) {
    ...
    /**
     * Get or create an instance of the {@link ouvriros.hardware.LiveDisplayManager}
     * @param context
    ...
    public static ILiveDisplayService getService() {
        ...
        IBinder b = ServiceManager.getService(OuvrirContextConstants.OUVRIR_LIVEDISPLAY_SERVICE);
        if (b != null) {
