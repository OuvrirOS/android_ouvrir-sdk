...
package ouvriros.content;

import android.Manifest;

/**
 * OuvrirOS specific intent definition class.
 */
public class Intent {
    ...
    public static final String ACTION_RECENTS_LONG_PRESS =
            "ouvriros.intent.action.RECENTS_LONG_PRESS";
    ...
    public static final String EXTRA_RECENTS_LONG_PRESS_RELEASE =
            "ouvriros.intent.extra.RECENTS_LONG_PRESS_RELEASE";
    ...
    public static final String ACTION_SCREEN_CAMERA_GESTURE =
            "ouvriros.intent.action.SCREEN_CAMERA_GESTURE";

    /**
     * Broadcast action: perform any initialization required for OuvrirHW services.
     ...
     *
     * Requires {@link ouvriros.platform.Manifest.permission#HARDWARE_ABSTRACTION_ACCESS}.
     * @hide
     */
    public static final String ACTION_INITIALIZE_OUVRIR_HARDWARE =
            "ouvriros.intent.action.INITIALIZE_OUVRIR_HARDWARE";
    ...
    public static final String ACTION_LID_STATE_CHANGED =
            "ouvriros.intent.action.LID_STATE_CHANGED";
    ...
    public static final String EXTRA_LID_STATE =
            "ouvriros.intent.extra.LID_STATE";
    ...
    public static final String ACTION_UPDATE_POWER_MENU =
            "ouvriros.intent.action.UPDATE_POWER_MENU";
    ...
    public static final String ACTION_INITIALIZE_LIVEDISPLAY =
            "ouvriros.intent.action.INITIALIZE_LIVEDISPLAY";
}
