...
import ouvriros.os.Build.OUVRIR_VERSION_CODES;
...
public final class Concierge {
    ...
    /**
     * Since there might be a case where new versions of the ouvrir framework use applications running
     ...
     * {@link OUVRIR_VERSION_CODES}
     * @hide
     */
    public static final int PARCELABLE_VERSION = OUVRIR_VERSION_CODES.ILAMA;
