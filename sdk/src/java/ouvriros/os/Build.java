...
/**
 * Information about the current OuvrirOS build, extracted from system properties.
 */
public class Build {
    /** Value used for when a build property is unknown. */
    public static final String UNKNOWN = "unknown";

    /** A build ID utilized to distinguish ouvriros versions */
    public static final String OUVRIROS_VERSION = getString("ro.ouvrir.version");

    /** A build ID string meant for displaying to the user */
    public static final String OUVRIROS_DISPLAY_VERSION = getString("ro.ouvrir.display.version");

    private static final SparseArray<String> sdkMap;
    static
    {
        sdkMap = new SparseArray<String>();
        sdkMap.put(OUVRIR_VERSION_CODES.APRICOT, "Apricot");
        sdkMap.put(OUVRIR_VERSION_CODES.BOYSENBERRY, "Boysenberry");
        sdkMap.put(OUVRIR_VERSION_CODES.CANTALOUPE, "Cantaloupe");
        sdkMap.put(OUVRIR_VERSION_CODES.DRAGON_FRUIT, "Dragon Fruit");
        sdkMap.put(OUVRIR_VERSION_CODES.ELDERBERRY, "Elderberry");
        sdkMap.put(OUVRIR_VERSION_CODES.FIG, "Fig");
        sdkMap.put(OUVRIR_VERSION_CODES.GUAVA, "Guava");
        sdkMap.put(OUVRIR_VERSION_CODES.HACKBERRY, "Hackberry");
        sdkMap.put(OUVRIR_VERSION_CODES.ILAMA, "Ilama");
    }

    /** Various version strings. */
    public static class OUVRIR_VERSION {
        /**
         * The user-visible SDK version of the framework; its possible
         * values are defined in {@link Build.OUVRIR_VERSION_CODES}.
         *
         * Will return 0 if the device does not support the Ouvrir SDK.
         */
        public static final int SDK_INT = SystemProperties.getInt(
                "ro.ouvrir.build.version.plat.sdk", 0);
    }

    /**
     * Enumeration of the currently known SDK version codes.  These are the
     * values that can be found in {@link OUVRIR_VERSION#SDK_INT}.  Version numbers
     ...
     *     if (Build.OUVRIR_VERSION.SDK_INT >= Build.OUVRIR_VERSION_CODES.BOYSENBERRY) {
     ...
     * </pre>
     */
    public static class OUVRIR_VERSION_CODES {
        /**
         ...
         * new features:</p>
         * <ul>
         * <li>Profiles API via {@link ouvriros.app.ProfileManager}
         * <li>Hardware Abstraction Framework Access via
         * {@link ouvriros.hardware.OuvrirHardwareManager} (Not for use by 3rd parties)
         * <li>Introductory Settings Provider {@link ouvriros.providers.OuvrirSettings}
         * </ul>
         */
         ...
         * {@link ouvriros.power.PerformanceManager}</li>
         * <li>Numerous new "System" settings exposed via the
         * {@link ouvriros.providers.OuvrirSettings.System} interface</li>
         * </ul>
         */
         ...
         * {@link ouvriros.weather.OuvrirWeatherManager}</li>
         * <li>Weather provider api to provide weather data to any listener on the device
         * {@link ouvriros.weatherservice.WeatherProviderService}</li>
         * <li>Parceling helper class {@link ouvriros.os.Concierge} to help with parcel
         ...
         * {@link ouvriros.hardware.OuvrirHardwareManager}, as well as do picture adjustment</li>
         * <li>Extended capabilities of the LiveDisplay interfaces, now providing
         * {@link ouvriros.hardware.LiveDisplayConfig} and a dedicated
         * {@link ouvriros.hardware.LiveDisplayManager}</li>
         * <li>Added new settings, such as LOCKSCREEN_ROTATION and DISPLAY_LOW_POWER
         * to {@link ouvriros.providers.OuvrirSettings}</li>
         * </ul>
         *
         * Signing out, Adnan \u270C
         */
        ...
        /**
         * February 2018: Unreleased preliminary version starting from OuvrirOS 15.1
         * <p>Unused APIs have been removed.</p>
         */
        public static final int HACKBERRY = 8;

        /**
         * March 2018: The 1st iteration of the platform sdk for OuvrirOS
         * <p>Applications targeting this or a later version will get access to these
         * new features!</p>
         * <ul>
