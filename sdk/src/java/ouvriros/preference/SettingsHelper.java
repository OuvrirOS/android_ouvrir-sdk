...
public class SettingsHelper {
    ...
    private static final String OUVRIRSETTINGS_GLOBAL = OuvrirSettings.Global.CONTENT_URI.toString();
    private static final String OUVRIRSETTINGS_SECURE = OuvrirSettings.Secure.CONTENT_URI.toString();
    private static final String OUVRIRSETTINGS_SYSTEM = OuvrirSettings.System.CONTENT_URI.toString();
    ...
    public String getString(Uri settingsUri) {
        ...
        } else if (uri.startsWith(OUVRIRSETTINGS_SECURE)) {
            return OuvrirSettings.Secure.getString(resolver, uri.substring(OUVRIRSETTINGS_SECURE.length()));
        } else if (uri.startsWith(OUVRIRSETTINGS_SYSTEM)) {
            return OuvrirSettings.System.getString(resolver, uri.substring(OUVRIRSETTINGS_SYSTEM.length()));
        } else if (uri.startsWith(OUVRIRSETTINGS_GLOBAL)) {
            return OuvrirSettings.Global.getString(resolver, uri.substring(OUVRIRSETTINGS_GLOBAL.length()));
        }
        return null;
    }
    ...
    public int getInt(Uri settingsUri, int def) {
        ...
        if (uri.startsWith(SETTINGS_SECURE)) {
            ...
            return OuvrirSettings.Secure.getInt(resolver, uri.substring(OUVRIRSETTINGS_SECURE.length()), def);
        } else if (uri.startsWith(OUVRIRSETTINGS_SYSTEM)) {
            return OuvrirSettings.System.getInt(resolver, uri.substring(OUVRIRSETTINGS_SYSTEM.length()), def);
        } else if (uri.startsWith(OUVRIRSETTINGS_GLOBAL)) {
            return OuvrirSettings.Global.getInt(resolver, uri.substring(OUVRIRSETTINGS_GLOBAL.length()), def);
        }
        return def;
    }
    ...
    public void putString(Uri settingsUri, String value) {
        ...
        if (uri.startsWith(SETTINGS_SECURE)) {
            ...
            OuvrirSettings.Secure.putString(resolver, uri.substring(OUVRIRSETTINGS_SECURE.length()), value);
        } else if (uri.startsWith(OUVRIRSETTINGS_SYSTEM)) {
            OuvrirSettings.System.putString(resolver, uri.substring(OUVRIRSETTINGS_SYSTEM.length()), value);
        } else if (uri.startsWith(OUVRIRSETTINGS_GLOBAL)) {
            OuvrirSettings.Global.putString(resolver, uri.substring(OUVRIRSETTINGS_GLOBAL.length()), value);
        }
    }
    ...
    public void putInt(Uri settingsUri, int value) {
        ...
        if (uri.startsWith(SETTINGS_SECURE)) {
            ...
            OuvrirSettings.Secure.putInt(resolver, uri.substring(OUVRIRSETTINGS_SECURE.length()), value);
        } else if (uri.startsWith(OUVRIRSETTINGS_SYSTEM)) {
            OuvrirSettings.System.putInt(resolver, uri.substring(OUVRIRSETTINGS_SYSTEM.length()), value);
        } else if (uri.startsWith(OUVRIRSETTINGS_GLOBAL)) {
            OuvrirSettings.Global.putInt(resolver, uri.substring(OUVRIRSETTINGS_GLOBAL.length()), value);
        }
    }
