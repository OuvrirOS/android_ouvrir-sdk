...
public class RemotePreference extends SelfRemovingPreference
    ...
    public static final String ACTION_REFRESH_PREFERENCE =
            "ouvriros.intent.action.REFRESH_PREFERENCE";

    public static final String ACTION_UPDATE_PREFERENCE =
            "ouvriros.intent.action.UPDATE_PREFERENCE";

    public static final String META_REMOTE_RECEIVER =
            "org.ouvriros.settings.summary.receiver";

    public static final String META_REMOTE_KEY =
            "org.ouvriros.settings.summary.key";

    public static final String EXTRA_ENABLED = ":ouvrir:pref_enabled";
    public static final String EXTRA_KEY = ":ouvrir:pref_key";
    public static final String EXTRA_SUMMARY = ":ouvrir:pref_summary";
