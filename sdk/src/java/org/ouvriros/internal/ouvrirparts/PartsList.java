 ...
 */
package org.ouvriros.internal.ouvrirparts;
...
import static ouvriros.platform.R.styleable.ouvrir_Searchable;
import static ouvriros.platform.R.styleable.ouvrir_Searchable_xmlRes;
...
public class PartsList {
    ...
    public static final String EXTRA_PART = ":ouvrir:part";

    public static final String OUVRIRPARTS_PACKAGE = "org.ouvriros.ouvrirparts";

    public static final ComponentName OUVRIRPARTS_ACTIVITY = new ComponentName(
            OUVRIRPARTS_PACKAGE, OUVRIRPARTS_PACKAGE + ".PartsActivity");

    public static final String PARTS_ACTION_PREFIX = OUVRIRPARTS_PACKAGE + ".parts";
    ...
    private void loadParts() {
        synchronized (mParts) {
            ...
            try {
                final Resources r = pm.getResourcesForApplication(OUVRIRPARTS_PACKAGE);
                if (r == null) {
                    return;
                }
                int resId = r.getIdentifier("parts_catalog", "xml", OUVRIRPARTS_PACKAGE);
                if (resId > 0) {
                    loadPartsFromResourceLocked(r, resId, mParts);
                }
            } catch (PackageManager.NameNotFoundException e) {
                // no ouvrirparts installed
            }
        }
    }
        ...
        try {
            ...
            while ((type = parser.next()) != XmlPullParser.END_DOCUMENT
                ...
                if ("part".equals(nodeName)) {
                    ...
                    sa = res.obtainAttributes(attrs, ouvrir_Searchable);
                    info.setXmlRes(sa.getResourceId(ouvrir_Searchable_xmlRes, 0));
