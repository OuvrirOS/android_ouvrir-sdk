...
import ouvriros.preference.RemotePreference;
 ...
 */
public class OuvrirPartsPreference extends RemotePreference {

    private static final String TAG = "OuvrirPartsPreference";

    private final PartInfo mPart;

    private final Context mContext;

    public OuvrirPartsPreference(Context context, AttributeSet attrs,
    ...
    public OuvrirPartsPreference(Context context, AttributeSet attrs, int defStyle) {
