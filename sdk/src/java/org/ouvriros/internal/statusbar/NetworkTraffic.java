...
package org.ouvriros.internal.statusbar;
...
public class NetworkTraffic extends TextView {
    ...
    private OuvrirStatusBarItem.DarkReceiver mDarkReceiver =
            new OuvrirStatusBarItem.DarkReceiver() {
    ...
    private OuvrirStatusBarItem.VisibilityReceiver mVisibilityReceiver =
            new OuvrirStatusBarItem.VisibilityReceiver() {
    ...
    protected void onAttachedToWindow() {
        ...
        OuvrirStatusBarItem.Manager manager =
                OuvrirStatusBarItem.findManager((View) this);
    ...
    class SettingsObserver extends ContentObserver {
        ...
        void observe() {
            ...
            resolver.registerContentObserver(OuvrirSettings.Secure.getUriFor(
                    OuvrirSettings.Secure.NETWORK_TRAFFIC_MODE),
                    false, this, UserHandle.USER_ALL);
            resolver.registerContentObserver(OuvrirSettings.Secure.getUriFor(
                    OuvrirSettings.Secure.NETWORK_TRAFFIC_AUTOHIDE),
                    false, this, UserHandle.USER_ALL);
            resolver.registerContentObserver(OuvrirSettings.Secure.getUriFor(
                    OuvrirSettings.Secure.NETWORK_TRAFFIC_UNITS),
                    false, this, UserHandle.USER_ALL);
            resolver.registerContentObserver(OuvrirSettings.Secure.getUriFor(
                    OuvrirSettings.Secure.NETWORK_TRAFFIC_SHOW_UNITS),
                    false, this, UserHandle.USER_ALL);
        }
    ...
    private void updateSettings() {
        ...
        mMode = OuvrirSettings.Secure.getInt(resolver,
                OuvrirSettings.Secure.NETWORK_TRAFFIC_MODE, 0);
        mAutoHide = OuvrirSettings.Secure.getInt(resolver,
                OuvrirSettings.Secure.NETWORK_TRAFFIC_AUTOHIDE, 0) == 1;
        mUnits = OuvrirSettings.Secure.getInt(resolver,
                OuvrirSettings.Secure.NETWORK_TRAFFIC_UNITS, /* Mbps */ 1);
        ...
        mShowUnits = OuvrirSettings.Secure.getInt(resolver,
                OuvrirSettings.Secure.NETWORK_TRAFFIC_SHOW_UNITS, 1) == 1;
