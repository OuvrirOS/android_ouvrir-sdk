...
package org.ouvriros.internal.notification;
...
public final class OuvrirNotificationLights {
    private static final String TAG = "OuvrirNotificationLights";
    ...
    public OuvrirNotificationLights(Context context, LedUpdater ledUpdater) {
        mContext = context;
        ...
        final String[] defaultMapping = res.getStringArray(
                org.ouvriros.platform.internal.R.array.notification_light_package_mapping);
    ...
    public boolean isForcedOn(Notification n) {
        if (n.extras != null) {
            return n.extras.getBoolean(OuvrirNotification.EXTRA_FORCE_SHOW_LIGHTS, false);
        }
        return false;
    }
    ...
    private int getForcedBrightness(Notification n) {
        if (n.extras != null) {
            return n.extras.getInt(OuvrirNotification.EXTRA_FORCE_LIGHT_BRIGHTNESS, 0);
        }
        return 0;
    }
    ...
    public int getForcedColor(Notification n) {
        if (n.extras != null) {
            return n.extras.getInt(OuvrirNotification.EXTRA_FORCE_COLOR, 0);
        }
        return 0;
    }
    ...
    public int getForcedLightOnMs(Notification n) {
        if (n.extras != null) {
            return n.extras.getInt(OuvrirNotification.EXTRA_FORCE_LIGHT_ON_MS, -1);
        }
        return -1;
    }
    ...
    public int getForcedLightOffMs(Notification n) {
        if (n.extras != null) {
            return n.extras.getInt(OuvrirNotification.EXTRA_FORCE_LIGHT_OFF_MS, -1);
        }
        return -1;
    }
    ...
    // updates them according to the active Ouvrir feature settings.
    ...
    class SettingsObserver extends ContentObserver {
        ...
        void observe() {
            ...
            resolver.registerContentObserver(OuvrirSettings.System.getUriFor(
                    ...
                    false, this, UserHandle.USER_ALL);
            resolver.registerContentObserver(OuvrirSettings.System.getUriFor(
                    OuvrirSettings.System.NOTIFICATION_LIGHT_COLOR_AUTO), false,
            ...
            if (mCanAdjustBrightness) {
                resolver.registerContentObserver(OuvrirSettings.System.getUriFor(
                        ...
                        false, this, UserHandle.USER_ALL);
                resolver.registerContentObserver(OuvrirSettings.System.getUriFor(
                        OuvrirSettings.System.NOTIFICATION_LIGHT_BRIGHTNESS_LEVEL_ZEN),
                        false, this, UserHandle.USER_ALL);
            }

            resolver.registerContentObserver(OuvrirSettings.System.getUriFor(
                    OuvrirSettings.System.ZEN_ALLOW_LIGHTS), false, this,
                    UserHandle.USER_ALL);
        ...
        private void update() {
            ...
            mAutoGenerateNotificationColor = OuvrirSettings.System.getIntForUser(resolver,
                    OuvrirSettings.System.NOTIFICATION_LIGHT_COLOR_AUTO,
                    1, UserHandle.USER_CURRENT) != 0;

            // LED default color
            mDefaultNotificationColor = OuvrirSettings.System.getIntForUser(resolver,
                    OuvrirSettings.System.NOTIFICATION_LIGHT_PULSE_DEFAULT_COLOR,
                    mDefaultNotificationColor, UserHandle.USER_CURRENT);

            // LED default on MS
            mDefaultNotificationLedOn = OuvrirSettings.System.getIntForUser(resolver,
                    OuvrirSettings.System.NOTIFICATION_LIGHT_PULSE_DEFAULT_LED_ON,
                    mDefaultNotificationLedOn, UserHandle.USER_CURRENT);

            // LED default off MS
            mDefaultNotificationLedOff = OuvrirSettings.System.getIntForUser(resolver,
                    OuvrirSettings.System.NOTIFICATION_LIGHT_PULSE_DEFAULT_LED_OFF,
            ...
            if (OuvrirSettings.System.getIntForUser(resolver,
                    OuvrirSettings.System.NOTIFICATION_LIGHT_PULSE_CUSTOM_ENABLE, 0,
                    UserHandle.USER_CURRENT) != 0) {
                parseNotificationPulseCustomValuesString(OuvrirSettings.System.getStringForUser(
                        resolver, OuvrirSettings.System.NOTIFICATION_LIGHT_PULSE_CUSTOM_VALUES,
                        UserHandle.USER_CURRENT));
            }

            // Notification lights with screen on
            mScreenOnEnabled = (OuvrirSettings.System.getIntForUser(resolver,
                    OuvrirSettings.System.NOTIFICATION_LIGHT_SCREEN_ON, 0,
                    UserHandle.USER_CURRENT) != 0);

            // Adustable notification LED brightness.
            if (mCanAdjustBrightness) {
                // Normal brightness.
                mNotificationLedBrightnessLevel = OuvrirSettings.System.getIntForUser(resolver,
                        OuvrirSettings.System.NOTIFICATION_LIGHT_BRIGHTNESS_LEVEL,
                        LedValues.LIGHT_BRIGHTNESS_MAXIMUM, UserHandle.USER_CURRENT);
                // Brightness in Do Not Disturb mode.
                mNotificationLedBrightnessLevelZen = OuvrirSettings.System.getIntForUser(
                        resolver, OuvrirSettings.System.NOTIFICATION_LIGHT_BRIGHTNESS_LEVEL_ZEN,
                        LedValues.LIGHT_BRIGHTNESS_MAXIMUM, UserHandle.USER_CURRENT);
            }

            mZenAllowLights = OuvrirSettings.System.getIntForUser(resolver,
