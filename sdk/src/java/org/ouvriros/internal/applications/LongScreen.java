...
package org.ouvriros.internal.applications;
...
public class LongScreen {
    ...
    public LongScreen(Context context) {
        ...
        mLongScreenAvailable = resources.getBoolean(
                org.ouvriros.platform.internal.R.bool.config_haveHigherAspectRatioScreen);
    ...
    public void addApp(String packageName) {
        ...
        OuvrirSettings.System.putString(mContext.getContentResolver(),
                OuvrirSettings.System.LONG_SCREEN_APPS, String.join(",", mApps));
    }
    ...
    class SettingsObserver extends ContentObserver {
        ...
        void observe() {
            ...
            resolver.registerContentObserver(OuvrirSettings.System.getUriFor(
                    OuvrirSettings.System.LONG_SCREEN_APPS), false, this,
                    UserHandle.USER_ALL);
        ...
        public void update() {
            ...
            String apps = OuvrirSettings.System.getStringForUser(resolver,
                    OuvrirSettings.System.LONG_SCREEN_APPS,
