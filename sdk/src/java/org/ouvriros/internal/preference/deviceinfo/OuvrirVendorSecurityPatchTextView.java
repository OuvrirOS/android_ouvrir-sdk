...
public class OuvrirVendorSecurityPatchTextView extends TextView {
    private static final String TAG = "OuvrirVendorSecurityPatchTextView";

    private static final String KEY_AOSP_VENDOR_SECURITY_PATCH =
            "ro.vendor.build.security_patch";

    private static final String KEY_OUVRIR_VENDOR_SECURITY_PATCH =
            "ro.ouvrir.build.vendor_security_patch";

    public OuvrirVendorSecurityPatchTextView(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    private String getVendorSecurityPatchLevel() {
        ...
        if (patchLevel.isEmpty()) {
            patchLevel = SystemProperties.get(KEY_OUVRIR_VENDOR_SECURITY_PATCH);
        }
