...
/**
 * This is to be run on a live Ouvrir 12.1 device.
 */
public class GenerateExampleSettings {
    ...
    public static void main(String[] args) throws IOException, ClassNotFoundException {
        ...
        for (Setting system : androidSystemSettingList) {
            if (OuvrirSettings.System.isLegacySetting(system.getKey())) {
                defaultSettings.add(system);
            }
        }

        for (Setting secure : androidSecureSettingList) {
            if (OuvrirSettings.Secure.isLegacySetting(secure.getKey())) {
                defaultSettings.add(secure);
            }
        }

        for (Setting global : androidGlobalSettingList) {
            if (OuvrirSettings.Global.isLegacySetting(global.getKey())) {
        ...
        out.write("# Settings which are to be moved to OuvrirSettings\n");
        out.write("# Automatically generated by " +
                "ouvrir-sdk/host/migration/src/GenerateExampleSettings"
