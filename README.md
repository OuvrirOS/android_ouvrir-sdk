...
You can either [download](https://github.com/LineageOS/android_prebuilts_ouvrir-sdk/tree/master/current) from prebuilts hosted on github or pull directly via Gradle.
...
```gradle
dependencies {
    compile 'org.ouvriros:platform.sdk:5.+'
}
```
...
```gradle
dependencies {
    compile 'org.ouvriros:platform.sdk:6.0-SNAPSHOT'
}
```

### Wiki

For further inquiries regarding this project, please reference the [wiki](https://wiki.ouvriros.org/sdk).
