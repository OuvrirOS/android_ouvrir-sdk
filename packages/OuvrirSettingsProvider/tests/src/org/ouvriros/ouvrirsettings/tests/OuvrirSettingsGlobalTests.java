...
public class OuvrirSettingsGlobalTests extends AndroidTestCase {
    ...
    public void testFloat() {
        ...
        OuvrirSettings.Global.putFloat(mContentResolver,
                OuvrirSettings.Global.__MAGICAL_TEST_PASSING_ENABLER, expectedFloatValue);

        try {
            float actualValue = OuvrirSettings.Global.getFloat(mContentResolver,
                    OuvrirSettings.Global.__MAGICAL_TEST_PASSING_ENABLER);
    ...
    public void testInt() {
        ...
        OuvrirSettings.Global.putInt(mContentResolver,
                OuvrirSettings.Global.__MAGICAL_TEST_PASSING_ENABLER, expectedIntValue);

        try {
            int actualValue = OuvrirSettings.Global.getInt(mContentResolver,
                    OuvrirSettings.Global.__MAGICAL_TEST_PASSING_ENABLER);
    ...
    public void testLong() {
        ...
        OuvrirSettings.Global.putLong(mContentResolver,
                OuvrirSettings.Global.__MAGICAL_TEST_PASSING_ENABLER, expectedLongValue);

        try {
            long actualValue = OuvrirSettings.Global.getLong(mContentResolver,
                    OuvrirSettings.Global.__MAGICAL_TEST_PASSING_ENABLER);
    ...
    public void testString() {
        ...
        OuvrirSettings.Global.putString(mContentResolver,
                OuvrirSettings.Global.__MAGICAL_TEST_PASSING_ENABLER, expectedStringValue);

        String actualValue = OuvrirSettings.Global.getString(mContentResolver,
                OuvrirSettings.Global.__MAGICAL_TEST_PASSING_ENABLER);
    ...
    public void testGetUri() {
        final Uri expectedUri = Uri.withAppendedPath(OuvrirSettings.Global.CONTENT_URI,
                OuvrirSettings.Global.__MAGICAL_TEST_PASSING_ENABLER);

        final Uri actualUri = OuvrirSettings.Global.getUriFor(
                OuvrirSettings.Global.__MAGICAL_TEST_PASSING_ENABLER);
